...
class ModelTests(TestCase):
    ...
    def test_create_user_with_email_successful(self):
        ...
        # check_password is provided by default model manager
    ...
    def test_recipe_file_name_uuid(self,mock_uuid):
        ...
        # going to create the path using uuid
        # as a unique identifier for the file 
        # we are going to upload
        uuid = 'test-uuid'
        mock_uuid.return_value = uuid
        # None will get replaced by instance,passed to this function by django image field
        # passing in the original name of the file is being uploaded i.e example.jpg
